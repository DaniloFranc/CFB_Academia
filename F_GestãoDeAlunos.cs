...
{
    public partial class F_GestãoDeAlunos : Form
    {
        string vqueryDGV = "";
        string turmaAtual = "";
        ...
        private void F_GestãoDeAlunos_Load(object sender, EventArgs e)
        {
            vqueryDGV = @"
                SELECT
                    N_IDALUNO as 'ID',
                ...
                SELECT 
                    ...
                    ('Vagas: ' || (
                                    (N_MAXALUNOS) - (
                                                    ...
                                                    FROM tb_alunos
                                                    WHERE N_IDTURMA = tb_turmas.N_IDTURMA AND T_STATUS = 'A'
                                                    )
        ...
        {
            // Fazer a rotina para alterar a foto e deletar a foto antiga do sistema
            // Fazer o código para construir no PDF a carteirinha do aluno no Botão "Imprimir PDF". 
        }
    }
}
